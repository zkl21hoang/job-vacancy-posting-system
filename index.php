...
<nav class="navbar sticky-top navbar-expand-lg bg-dark navbar-dark">
    ...
    <div class="justify-content-center">
        <div class="h2 text-center align-middle py-3">Posting the chances and help candidates seeking their love Jobs now.</div>
    </div>
</div>
<br />
...
<div style="background-color:#CFCFCF">
    <div class="container-lg py-3">
        <div class="p py-2">Email: name@mail.com<a href="mailto:name@mail.com" style="color:orangered">name@mail.com</a></div>
    </div>
</div>
